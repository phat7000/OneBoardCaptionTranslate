...
namespace LiveCaptionsTranslator.models
{
    ...
    {
        public const string FILENAME = ApplicationDataPaths.SettingsFileName;
        ...
        {
            string jsonPath = ApplicationDataPaths.SettingsFile;
            try
            {
        ...
        public static Setting Load(string jsonPath)
        {
            ...
            // OneBoard does not ship the upstream Google2 provider. Preserve compatibility
            ...
            setting.Configs.Remove("Google2");
            setting.ConfigIndices.Remove("Google2");
        ...
        public void Save()
        {
            Save(ApplicationDataPaths.SettingsFile);
        }
        ...
        {
            return File.Exists(ApplicationDataPaths.SettingsFile);
        }
    }
}
