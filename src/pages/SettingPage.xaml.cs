...
namespace LiveCaptionsTranslator
{
    public partial class SettingPage : Page
    {
        ...
        public SettingPage()
        {
            ...
            // Only registered providers are selectable. A legacy setting file may still
            // contain configuration entries for providers that OneBoard no longer ships.
            TranslateAPIBox.ItemsSource = TranslateAPI.TRANSLATE_FUNCTIONS.Keys;
